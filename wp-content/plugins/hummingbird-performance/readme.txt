...
Plugin Name: Hummingbird – Speed Up WordPress
Version: 2.0.1
Author: WPMU DEV
Author URI: http://premium.wpmudev.org/
Contributors: WPMUDEV
Tags: speed up wordpress, wordpress speed optimization, page speed, wordpress cache plugin, wordpress performance optimization
...
Did you know that the more files you add to your site’s header, the slower it will load? With Hummingbird, you can easily customize the load position of your files to increase your page speed.
